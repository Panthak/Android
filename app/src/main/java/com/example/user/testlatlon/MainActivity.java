        ...
        listCity.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    pos = position;
                    new JSONTask().execute("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=22.3072,73.1812&keyword=food&radius=1000&type=restaurant&key=AIzaSyACU2rnlOPfkSpEL-n5giMJtRJadcQWsSw");
                }
            }
        });
    }
